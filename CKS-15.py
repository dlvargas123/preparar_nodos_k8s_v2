...
def run_validation():
    ...
    with open(REPORT_FILE, "w") as report:
        ...
        try:
            # 1. Obtener el proceso activo para inspeccionar los flags
            ...
            if TARGET_PLUGIN in process_output and ENABLE_FLAG in process_output:
                ...
                status = f"FALLO: El plugin {TARGET_PLUGIN} NO se detectó en la ejecución del API Server."
            ...
            # 3. Salud del API Server (Equivalente al punto 4 de tu solicitud)
            report.write("-" * 30 + "\n")
...
if __name__ == "__main__":
    if os.geteuid() != 0:
        print("Error: Se requiere privilegios de ROOT para inspeccionar el proceso del API Server.")
    else:
        run_validation()

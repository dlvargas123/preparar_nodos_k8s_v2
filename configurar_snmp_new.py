...
def ensure_snmp_directory():
    ...
    if not os.path.exists(snmp_dir):
        ...
        subprocess.run(["sudo", "mkdir", "-p", snmp_dir], check=True)
...
# Nuevos servidores SNMP autorizados
com2sec snmpserver      10.189.10.11      ifxcliente
com2sec snmpserver      10.189.10.12      ifxcliente
com2sec snmpserver      45.227.200.2      ifxcliente
    ...
    try:
        ...
        if os.path.exists(config_file_path):
            with open(config_file_path, "r") as file:
                ...
                if (
                    "rocommunity     ifxcliente" in content
                    and "rwcommunity     ifxcliente" in content
                    and "com2sec snmpserver      10.189.10.11" in content
                    and "com2sec snmpserver      10.189.10.12" in content
                    and "com2sec snmpserver      45.227.200.2" in content
                ):
